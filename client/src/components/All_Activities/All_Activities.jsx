            ...
            return (
              <div>
                <div key={el.id} className={s.activity} >
                  <p><b>Actividad: </b>{el.name}</p>
                  <p><b>Duración: </b>{el.duration}</p>
                  <p><b>Dificultad: </b>{el.difficulty}</p>
                  <p><b>Temporada: </b>{el.season}</p>
                  <button onClick={() => handleClick(el.id, el.name)} >ELIMINAR</button>
                </div>
              </div>
            );
          })
